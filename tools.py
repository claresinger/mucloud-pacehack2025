...
def plot_hist(cdnc,lwp):
    ...
    xbins = np.logspace(1,3.5,50) # <- make a range from 10**xmin to 10**xmax
    #print(xbins)
    ybins = np.logspace(1,3.5,50) # <- make a range from 10**ymin to 10**ymax
    #print(xbins,ybins)
    ...
    im = ax.pcolormesh(xedge,yedge,h_norm,cmap='turbo')
